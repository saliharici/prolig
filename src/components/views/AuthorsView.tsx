...
export const AuthorsView: React.FC<AuthorsViewProps> = ({ onAddAuthor, onSelectAuthor }) => {
  ...
  return (
    <div className="space-y-5">
      ...
      <PageBanner
        title={
          <><span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">Yazarlar</span> Dizini</>
        }
        description={`Türkiye genelinde aktif görev alan ${authors.length} branş uzmanı ve yazar listeleniyor.`}
        badge={
          <>
        ...
        orb1Color="bg-emerald-500"
        orb2Color="bg-teal-500"
        actions={
          <>
            <button
              onClick={handleExportCSV}
              className="flex items-center gap-1.5 rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-xs font-bold text-white hover:bg-white/20 transition-all backdrop-blur-md shadow-lg"
            >
